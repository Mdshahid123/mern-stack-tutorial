...
//let and const are Block Scoped ✅ as well as Function Scoped ✅ (since a function is a block)
//This means let and const are only accessible inside the {} where they are declared.


// where as ✅ var ❌ Not block scoped it is only ✅ Function Scoped only

//If var is declared in a block (like an if, for, or {}), it ignores the block and is hoisted to the nearest function scope or global scope if no function exists.
